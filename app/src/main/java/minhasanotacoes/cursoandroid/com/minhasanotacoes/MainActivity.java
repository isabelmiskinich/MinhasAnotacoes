...
public class MainActivity extends Activity{
    ...
    private static final String NOME_ARQUVIVO = "arquivo_anotacao.txt";
    ...
    private void gravarNoArquivo (String texto) {
        ...
        try {
            ...
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(openFileOutput(NOME_ARQUVIVO, Context.MODE_PRIVATE));
    ...
    private String lerArquivo () {
        ...
        try {
            ...
            InputStream arquivo = openFileInput(NOME_ARQUVIVO);
